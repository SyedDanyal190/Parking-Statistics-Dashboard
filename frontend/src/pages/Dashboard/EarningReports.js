                    ...
                    <CardBody>
                        <Row className="align-items-center">
                            <Col sm={8}>
                                ...
                                <p className="font-size-18">Data synchronise <b>30 minutes</b> ago <i className="mdi mdi-arrow-right"></i></p>
                                <div className="mt-4">
                                    <Link to="/pages-pricing" className="btn btn-success waves-effect waves-light">Sync Now!</Link>
                                </div>
                            </Col>
